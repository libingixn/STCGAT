...
class LoadData(Dataset):
    ...
    def slice_data(data, history_length, predict_length, index):
        ...
        # data_y = data[:, end_index: predict_length]
        #
        # print("*******************")
        # print("end_index:", end_index)
        # print("end_index+predict_length:", end_index+predict_length)
        # print("*******************")
